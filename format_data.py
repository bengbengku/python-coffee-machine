...
def is_resource_ingredients(order_ingredients):
    """Returns True jika penyimpanan mencukupi, False jika bahan baku tidak cukup"""
...
def process_coin():
    """Returns kalkulasi total dari coin inputan"""
...
def is_transaction_successfull(money_received, drink_cost):
    """Returns True ketika pembayaran disetujui, atau False jika uang tidak cukup."""
